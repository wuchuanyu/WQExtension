...
#import "WQGCDTimerManager.h"

@interface WQGCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation WQGCDTimerManager

#pragma mark - Public Method

+ (WQGCDTimerManager *)sharedInstance
{
    static WQGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[WQGCDTimerManager alloc] init];
    });
